...
load_dotenv()               # getting configuration variables from .env file
twilio_client = Client()    # encapsulates all of the Twilio API function

app = Flask(__name__)       # create flask instance



chatrooms_cli = AppGroup('chatrooms', help='Manage your chat rooms.')   # command group added to flask command
app.cli.add_command(chatrooms_cli)


@chatrooms_cli.command('list', help='list all chat rooms')              # list command -> gets list of conversations
def list():
...
@chatrooms_cli.command('create', help='create a chat room')             # new command group added
@click.argument('name')                                                 # takes a "name" argument
def create(name):
    conversation = None
